...
class Histogram extends Transformation implements ListenerInterface {
     ...
     *
     * The histogram will be generated as a 256px wide image, unless a different scale setting is provided. 
     * The end image size will be 256px * scale factor. Use the resize/maxsize transformations to generate a 
     * smaller version of the end image, which will then be anti-aliased on resize.
     *
    ...
    public function transform(EventInterface $event) {
        ...
        try {
            ...
            // set background as transparent before finishing, to allow for proper AA in later transformations
