    ...
    public static function getAllowedMethodsParams(): array
    {
        return [
            'default' => [
                'params' => [],
                'events' => [
                    'index.get' => ['invoke' => 1_000],
                    'index.head' => ['invoke' => 1_000],
                    'index.options' => ['options' => 20],

                    'image.get' => ['invoke' => 1_000],
                    'image.head' => ['invoke' => 1_000],
                    'image.options' => ['options' => 20],

                    'images.get' => ['invoke' => 1_000],
                    'images.head' => ['invoke' => 1_000],
                    'images.options' => ['options' => 20],

                    'globalimages.get' => ['invoke' => 1_000],
                    'globalimages.head' => ['invoke' => 1_000],
                    'globalimages.options' => ['options' => 20],

                    'metadata.get' => ['invoke' => 1_000],
                    'metadata.head' => ['invoke' => 1_000],
                    'metadata.options' => ['options' => 20],

                    'status.get' => ['invoke' => 1_000],
                    'status.head' => ['invoke' => 1_000],
                    'status.options' => ['options' => 20],

                    'stats.get' => ['invoke' => 1_000],
                    'stats.head' => ['invoke' => 1_000],
                    'stats.options' => ['options' => 20],

                    'user.get' => ['invoke' => 1_000],
                    'user.head' => ['invoke' => 1_000],
                    'user.options' => ['options' => 20],

                    'globalshorturl.get' => ['invoke' => 1_000],
                    'globalshorturl.head' => ['invoke' => 1_000],
                    'globalshorturl.options' => ['options' => 20],

                    'shorturl.get' => ['invoke' => 1_000],
                    'shorturl.head' => ['invoke' => 1_000],
                    'shorturl.options' => ['options' => 20],

                    'shorturls.get' => ['invoke' => 1_000],
                    'shorturls.head' => ['invoke' => 1_000],
