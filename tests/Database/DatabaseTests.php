...
abstract class DatabaseTests extends TestCase {
    ...
    public function testDeleteImages() : void {
        ...
        $this->adapter->load($user, $imageIdentifier, $this->createMock(Image::class));
    }
     ...
     * @covers ::getLastModified
     */
    public function testCanGetLastModifiedDate(array $images, array $users, ?string $imageIdentifier, ?bool $compareDateTimeValue, ?DateTime $expectedDateTime = null) : void {
    ...
    public function testMetadataWithNestedArraysIsRepresetedCorrectly() : void {
        ...
        if ($this->adapter instanceof Doctrine) {
            // Use a less strict assertion as the Doctrine adapter don't handle types
    ...
    public function testGetImagesReturnsImagesWithDateTimeInstances() : void {
        ...
        $images = $this->adapter->getImages(['user'], new Query(), $this->createMock(Images::class));
