 ...
 * feature context that extends this one, and which also implements the FeatureContext interface.
 * The feature context classes can also implement Behat-hooks that does setup / teardown
 * type functionality.
 *
 * @author Christer Edvartsen <cogo@starzinger.net>
 * @package Test suite\Functional tests
 */
class MainFeatureContext extends ApiContext {
    /**
    ...
    public function setClient(ClientInterface $client) {
        ...
        $handler->push(Middleware::mapRequest(function (RequestInterface $request) {
            if (!$this instanceof FeatureContext) {
