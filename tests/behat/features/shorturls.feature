Feature: Imbo can generate short URLs for images on demand
    ...
    Scenario: Generate a short URL
        ...
        And the request body contains:
          """
          {"imageIdentifier": "929db9c5fc3099f7576f5655207eba47", "publicKey": "publickey", "extension": "gif", "query": "t[]=thumbnail:width=45,height=55&t[]=desaturate"}
          """
        When I request "/users/publickey/images/929db9c5fc3099f7576f5655207eba47/shorturls.json" using HTTP "POST"
    ...
    Scenario Outline: Request an image using the short URL
        ...
        Examples:
            ...
            | {"imageIdentifier": "929db9c5fc3099f7576f5655207eba47", "publicKey": "publickey"}                                                                                 | image/png  | 665   | 463    |
            | {"imageIdentifier": "929db9c5fc3099f7576f5655207eba47", "publicKey": "publickey", "extension": "gif"}                                                             | image/gif  | 665   | 463    |
            | {"imageIdentifier": "929db9c5fc3099f7576f5655207eba47", "publicKey": "publickey", "query": "t[]=thumbnail"}                                                       | image/png  | 50    | 50     |
            | {"imageIdentifier": "929db9c5fc3099f7576f5655207eba47", "publicKey": "publickey", "query": "t[]=thumbnail:width=45,height=55&t[]=desaturate"}                     | image/png  | 45    | 55     |
            | {"imageIdentifier": "929db9c5fc3099f7576f5655207eba47", "publicKey": "publickey", "extension": "jpg", "query": "t[]=thumbnail:width=45,height=55&t[]=desaturate"} | image/jpeg | 45    | 55     |
